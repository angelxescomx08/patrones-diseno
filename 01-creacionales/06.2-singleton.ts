...
class DatabaseConnection {
  ...
  public connect(): void {
    ...
    if (!this.connected) {
      console.log(`Conectado a la base de datos: ${COLORS.green}✔️`);
      this.connected = true;
      return;
    }
    console.log(`Ya estás conectado a la base de datos: ${COLORS.green}✔️`);
  }
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      console.log(`Desconectado de la base de datos: ${COLORS.red}❌`);
      this.connected = false;
      return;
    }
    console.log(`No estás conectado a la base de datos: ${COLORS.red}❌`);
  }
}
